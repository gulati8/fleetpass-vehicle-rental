...
describe('LeadService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw BadRequestException if customer not found', async () => {
      ...
      await expect(service.create(createDto, 'user-456')).rejects.toThrow(
        BadRequestException,
      );
    });
    ...
    it('should throw BadRequestException if vehicle not found', async () => {
      ...
      await expect(service.create(dtoWithVehicle, 'user-456')).rejects.toThrow(
        BadRequestException,
      );
    });
  ...
  describe('findAll', () => {
    ...
    it('should filter by status', async () => {
      ...
      await service.findAll({ status: 'new', page: 1, limit: 10 });
    ...
    it('should filter by source', async () => {
      ...
      await service.findAll({ source: 'website', page: 1, limit: 10 });
    ...
    it('should filter by assignedToId', async () => {
      ...
      await service.findAll({ assignedToId: 'user-123', page: 1, limit: 10 });
  ...
  describe('findOne', () => {
    ...
    it('should throw NotFoundException if lead not found', async () => {
      ...
      await expect(service.findOne('lead-999')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it('should update a lead successfully', async () => {
      ...
      const result = await service.update('lead-123', updateDto);
    ...
    it('should throw NotFoundException if lead not found', async () => {
      ...
      await expect(service.update('lead-999', updateDto)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it('should validate status transitions', async () => {
      ...
      await expect(service.update('lead-123', invalidUpdate)).rejects.toThrow(
        BadRequestException,
      );
    });
    ...
    it('should allow valid status transitions', async () => {
      ...
      const result = await service.update('lead-123', { status: 'contacted' });
    ...
    it('should throw BadRequestException if customer not found when updating customerId', async () => {
      ...
      await expect(
        service.update('lead-123', { customerId: 'customer-999' }),
    ...
    it('should throw BadRequestException if vehicle not found when updating vehicleInterestId', async () => {
      ...
      await expect(
        service.update('lead-123', { vehicleInterestId: 'vehicle-999' }),
      ).rejects.toThrow(BadRequestException);
    });
  });
  ...
  describe('remove', () => {
    ...
    it('should throw NotFoundException if lead not found', async () => {
      ...
      await expect(service.remove('lead-999')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('assign', () => {
    ...
    it('should assign a lead to a user successfully', async () => {
      ...
      const result = await service.assign('lead-123', assignDto);
    ...
    it('should throw NotFoundException if lead not found', async () => {
      ...
      await expect(service.assign('lead-999', assignDto)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it('should throw BadRequestException if user not found', async () => {
      ...
      await expect(service.assign('lead-123', assignDto)).rejects.toThrow(
        BadRequestException,
      );
    });
  ...
  describe('convert', () => {
    ...
    it('should convert a lead to a deal successfully', async () => {
      ...
      const result = await service.convert('lead-123', convertDto);
    ...
    it('should throw ConflictException if lead already converted', async () => {
      ...
      await expect(service.convert('lead-123', convertDto)).rejects.toThrow(
        ConflictException,
      );
    });
